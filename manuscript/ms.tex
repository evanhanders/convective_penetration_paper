...
The interface with the radiative zone is stiff, and so convective motions excite waves at a shallow angle above the radiative-convective boundary.
...
Boxed data points show the location of landmark simulation from Fig.~\ref{fig:parameter_space}.
...
We briefly examined what the impliciations of this theory could be for a simple stellatellarr model.
