...
We will now describe the setup of the two types of simulations conducted in this work (Case I and Case II).
As a visual aid, we provide Fig.~\ref{fig:parameter_space} to guide the eye to the portion of parameter space that we have studied in each of these cases.
We denote two ``landmark cases'' using a purple box (Case I landmark) and an orange box (Case II landmark), and throughout this work we will call out data from these cases with a similar box to guide the eye.
...
\caption{
Each marker corresponds to a simulation conducted in this work in the $\mR-\mP$ parameter space at $\mS = 10^3$. 
...
We additionally conduct Case I simulations at fixed $\mR$ and $\mP$ while varying $\mS$; these simulations occur at P = 4 and R = 400 and are denoted by a green ``x.''
The two ``landmark'' simulations are denoted by boxes.
...
\caption{
Shown are temperature anomalies in the landmark simulations.
(top) Case I landmark ($\mR = 400$, $\mP_D = 4$, $\mS = 10^3$) and (bottom) Case II landmark ($\mR = 800$, $\mP_L = 4$, $\mS = 10^3$).
The temporally- and volume- averaged Reynolds number in the convection zone is $\sim 250$ in the top panel and $\sim 350$ in the bottom panel.
As in Fig.~\ref{fig:vertical_dynamics_panels}, the boundary between the penetrative and radiative zones is shown as a solid horizontal line.
The boundary between the penetrative zone and bulk convection zone is shown as a dashed horizontal line.
In the bottom panel, there is an additional dashed horizontal line near the bottom of the domain; the linearly increasing conductivity creates a second PZ there where $\justgrad \approx \gradad > \gradrad$ below internal heating layer.
We see that temperature anomalies have different signs in the bulk CZ and PZ, as in Fig.~\ref{fig:vertical_dynamics_panels}.
...
The bulk reynolds number in the convection zones of these simulations are (top) $\sim 250$ and (bottom) $\sim 350$.
...
Case II simulations have a linearly increasing conductivity $k$ in the convection zone, so there is formally a small penetrative region where $\justgrad \approx \gradad > \gradrad$ at the base of the domain below the internal heating layer.
...
Boxed data points show the location of landmark simulations from Fig.~\ref{fig:parameter_space}.
...
Boxed data points show the location of the landmark simulation from Fig.~\ref{fig:parameter_space}.
