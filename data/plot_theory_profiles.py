...
ax_grad.fill_between((1.3, 1.39), 0, 2, facecolor='grey', alpha=0.5, rasterized=True)
...
ax_grad.text(1.044 + (0.3-0.044)/2, 1.1, 'PZ', ha='center', va='center')
...
ax_flux.set_ylabel(r'$\overline{\mathcal{F}_z}$')
