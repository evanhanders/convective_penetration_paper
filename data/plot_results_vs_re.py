...
ax1.scatter(Re[good_sf], d05[good_sf], facecolor=(1,1,1,0.5), color='k', marker='o', label='SF')
...
ax1.scatter(Re[good_ns], d05[good_ns], color='k', marker='o', label='NS', alpha=0.8, s=15)
